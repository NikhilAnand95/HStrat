...
public class ReadInput_ESP
{
  ...
  public void read_configFile() throws Exception 
  {
   ...
   public int cal_simulations(double ci, double epsilon)
	{
		int num_sims = 0;
   ...
   public void simulation() throws IOException
   {
		double ci = 0.15;
	   	double epsilon = 0.05;	 
	   	int num_sims = cal_simulations(ci, epsilon);	   
	   	System.out.println(num_sims);   
	   	
	        String fileName = path_output_folder + "smc.txt";
		FileWriter fw   =  new FileWriter(fileName, true);		  
	   	...
	   	for(int i=0; i<=10; i++)
	   	{
	   	        if(i%2 == 0)
			{
			   ...
			   boolean isValid = ses.start_simulation(init_prob_of_people, init_prob_of_HCUs, adj_matrix_of_graph, init_infected_people, trans_prob_of_people, trans_prob_of_HCUs, degree_node, hm);
