...
{    
    ...
    public void read_configFile() throws Exception 
    {
  	 ...
  	 try 
  	 {
  		...
  		path_position_folder = props.getProperty("location_of_position_folder");
        path_state_folder    = props.getProperty("location_of_state_folder");
        path_mapping_folder	 = props.getProperty("location_of_mapping_folder"); 
	...
	public static void main(String args[]) throws Exception
	{
		...
		GenInput gi = new GenInput(config_File);
		 ...
		 gi.read_init_pop_at_each_node(System.getProperty("user.dir")+ "/../../Input/ESP_Resources/resources/initial_population_at_each_node.txt", population);	
